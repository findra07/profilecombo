...
<body>
    <div class="page-wrapper">
        ...
        <div class="tp-banner-container sliderWraper">
            <div class="tp-banner">
                <ul>
                    <li data-slotamount="7" data-transition="pop" data-masterspeed="1000" data-saveperformance="on"> <img alt="" src="<?php echo base_url() ?>assets/images/dummy.png" data-lazyload="<?php echo base_url() ?>assets/images/tokobanner.jpg">
                    ...
                    <li data-slotamount="7" data-transition="slidedown" data-masterspeed="1000" data-saveperformance="on"> <img alt="" src="<?php echo base_url() ?>assets/images/dummy.png" data-lazyload="<?php echo base_url() ?>assets/images/banner-2.jpg">
                        <div class="caption lft large-title tp-resizeme slidertext4" data-x="center" data-y="160" data-speed="600" data-start="1600">Welcome to Construction Company</div>
                        <div class="caption lft large-title tp-resizeme slidertext1" data-x="center" data-y="200" data-speed="600" data-start="2200">We Build Big Things For Our Peoples</div>
                        <div class="caption lfb large-title tp-resizeme slidertext2" data-x="center" data-y="310" data-speed="600" data-start="2800">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris dapibus ex sed eros molestie blandit. Fusce <br />
                            sem enim, commodo sit amet diam pharetra, aliquet pulvinar purus.</div>
        ...
        <section class="about-info">
            <div class="about-img-pro" style="background-image:url(<?php echo base_url() ?>assets/images/group.jpg)"></div>
            <div class="container">
                <!--row start-->
                <div class="row">
                    <!--col start-->
                ...
                <div class="portfolio-inner">
                    ...
                    <ul class="row container-masonry  portfolio-posts grid">
                        ...
                        <li class="col-md-3 col-sm-6 col-xs-12 nf-item grid-sizer branding">
                            <div class="image-hover-effect"> <img src="<?php echo base_url() ?>assets/images/gallery/01.jpg" alt="img-1">
                                <div class="caption">
                                    <h3>Business Financing</h3>
                                    <p>True running burns more calories</p>
                                </div>
                                <div class="link-wrap"> <a href="<?php echo base_url() ?>assets/images/gallery/01.jpg" title="Business Financing" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
                            </div>
                        </li>
                        <!--col end-->
                        <!--col start-->
                        <li class="col-md-3 col-sm-6 col-xs-12 nf-item financing promotion">
                            <div class="image-hover-effect-1"> <img src="<?php echo base_url() ?>assets/images/gallery/02.jpg" alt="img-2">
                                <div class="caption">
                                    <h3>Business Financing</h3>
                                    <p>Check out the most populer sweets</p>
                                </div>
                                <div class="link-wrap"> <a href="<?php echo base_url() ?>assets/images/gallery/02.jpg" title="Business Financing" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
                            </div>
                        </li>
                        <!--col end-->
                        <!--col start-->
                        <li class="col-md-3 col-sm-6 col-xs-12 nf-item grid-sizer marketing branding promotion">
                            <div class="image-hover-effect-2"> <img src="<?php echo base_url() ?>assets/images/gallery/03.jpg" alt="img-3">
                                <div class="caption">
                                    <h3>Business Financing</h3>
                                    <p>True running burns more calories</p>
                                </div>
                                <div class="link-wrap"> <a href="<?php echo base_url() ?>assets/images/gallery/03.jpg" title="Business Financing" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
                            </div>
                        </li>
                        <!--col end-->
                        <!--col start-->
                        <li class="col-md-3 col-sm-6 col-xs-12 nf-item branding marketing">
                            <div class="image-hover-effect-3"> <img src="<?php echo base_url() ?>assets/images/gallery/04.jpg" alt="img-4">
                                <div class="caption">
                                    <h3>Business Financing</h3>
                                    <p>Check out the most populer sweets</p>
                                </div>
                                <div class="link-wrap"> <a href="<?php echo base_url() ?>assets/images/gallery/04.jpg" title="Business Financing" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
                            </div>
                        </li>
                        <!--col end-->
                        <!--col start-->
                        <li class="col-md-3 col-sm-6 col-xs-12 nf-item financing marketing branding">
                            <div class="image-hover-effect-4"> <img src="<?php echo base_url() ?>assets/images/gallery/05.jpg" alt="img-5">
                                <div class="caption">
                                    <h3>Business Financing</h3>
                                    <p>True running burns more calories</p>
                                </div>
                                <div class="link-wrap"> <a href="<?php echo base_url() ?>assets/images/gallery/05.jpg" title="Business Financing" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
                            </div>
                        </li>
                        <!--col end-->
                        <!--col start-->
                        <li class="col-md-3 col-sm-6 col-xs-12 nf-item financing marketing branding">
                            <div class="image-hover-effect-5"> <img src="<?php echo base_url() ?>assets/images/gallery/06.jpg" alt="img-6">
                                <div class="caption">
                                    <h3>Business Financing</h3>
                                    <p>Check out the most populer sweets</p>
                                </div>
                                <div class="link-wrap"> <a href="<?php echo base_url() ?>assets/images/gallery/06.jpg" title="Business Financing" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
                            </div>
                        </li>
                        <!--col end-->
                        <!--col start-->
                        <li class="col-md-3 col-sm-6 col-xs-12 nf-item financing marketing branding">
                            <div class="image-hover-effect-6"> <img src="<?php echo base_url() ?>assets/images/gallery/07.jpg" alt="img-7">
                                <div class="caption">
                                    <h3>Business Financing</h3>
                                    <p>Check out the most populer sweets</p>
                                </div>
                                <div class="link-wrap"> <a href="<?php echo base_url() ?>assets/images/gallery/07.jpg" title="Business Financing" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
                            </div>
                        </li>
                        <!--col end-->
                        <!--col start-->
                        <li class="col-md-3 col-sm-6 col-xs-12 nf-item financing marketing branding">
                            <div class="serviceWrap"> <img src="<?php echo base_url() ?>assets/images/gallery/08.jpg" alt="img-8">
                                <div class="caption">
                                    <h3>Business Financing</h3>
                                    <p>Lorem ipsum dolor</p>
                                </div>
                                <div class="link-wrap"> <a href="<?php echo base_url() ?>assets/images/gallery/08.jpg" title="Brand Promotion" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
                            </div>
                        </li>
                        <!--col end-->
                    </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="about-video-item">
                            <div class="about-video-img"> <img src="<?php echo base_url() ?>assets/images/welcome-1.jpg" alt=""> <a href="https://www.youtube.com/watch?v=Vn_FGpZJqUs" class="video-play mfp-iframe xs-video"><i class="fa fa-play"></i></a> </div>
                        </div>
                    </div>
                    <!--col end-->
                </div>
        ...
        <div class="testimonials-wrap">
            <div class="container">
                ...
                <ul class="owl-carousel">
                    <li class="item">
                        <div class="testiWrp">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut imperdiet odio a lectus dictum, et porttitor libero condimentum. Donec sollicitudin ex eleifend justo consectetur lobortis. </p>
                            <div class="clientInfo">
                                <div class="clientImg"><img alt="" src="<?php echo base_url() ?>assets/images/testimonial-1.jpg"></div>
                ...
                <ul class="row blog-grid">
                    ...
                    <li class="col-md-4 col-sm-12 ">
                        <div class="blog-inter">
                            <figure class="style-greens-two green"> <img src="<?php echo base_url() ?>assets/images/blog.jpg" alt="sq-sample2">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris eu nulla eget nisl dapibus finibus. Maecenas quis sem vel neque rhoncus dignissim. Ut et eros rhoncus, gravida tellus auctor, lobortis diam. In eu porta purus.</p>
                        </div>
                    </li>
                    <!--col end-->
                    <!--col start-->
            ...
            <div class="container">
                <div class="brand-content">
                    <ul class="brand-slider">
                        <li>
                            <figure class="logo-grey-style"> <img src="<?php echo base_url() ?>assets/images/company-logo/1.png" alt="themeforest" class="img-responsive">
                                <figcaption>
                                    <h5>Themeforest</h5>
                                </figcaption>
                        ...
                        <li>
                            <figure class="logo-grey-style"> <img src="<?php echo base_url() ?>assets/images/company-logo/2.png" alt="photodune" class="img-responsive">
                                <figcaption>
                                    <h5>Photodune</h5>
                                </figcaption>
                                <a href="https://photodune.net/" target="_blank"></a>
                            </figure>
                        </li>
                        <li>
                            <figure class="logo-grey-style"> <img src="<?php echo base_url() ?>assets/images/company-logo/3.png" alt="audiojungle" class="img-responsive">
                                <figcaption>
                                    <h5>Audiojungle</h5>
                                </figcaption>
                                <a href="https://audiojungle.net/" target="_blank"></a>
                            </figure>
                        </li>
                        <li>
                            <figure class="logo-grey-style"> <img src="<?php echo base_url() ?>assets/images/company-logo/4.png" alt="codecanyon" class="img-responsive">
                                <figcaption>
                                    <h5>Codecanyon</h5>
                                </figcaption>
                                <a href="https://codecanyon.net/" target="_blank"></a>
                            </figure>
                        </li>
                        <li>
                            <figure class="logo-grey-style"> <img src="<?php echo base_url() ?>assets/images/company-logo/5.png" alt="graphicriver" class="img-responsive">
                                <figcaption>
                                    <h5>Graphicriver</h5>
                                </figcaption>
                                <a href="https://graphicriver.net/" target="_blank"></a>
                            </figure>
                        </li>
                        <li>
                            <figure class="logo-grey-style"> <img src="<?php echo base_url() ?>assets/images/company-logo/6.png" alt="3docean" class="img-responsive">
                                <figcaption>
                                    <h5>3docean</h5>
                                </figcaption>
                                <a href="https://3docean.net/" target="_blank"></a>
                            </figure>
                        </li>
                        <li>
                            <figure class="logo-grey-style"> <img src="<?php echo base_url() ?>assets/images/company-logo/7.png" alt="videohive" class="img-responsive">
                                <figcaption>
                                    <h5>Videohive</h5>
                                </figcaption>
                                <a href="https://videohive.net/" target="_blank"></a>
                            </figure>
                        </li>
                        <li>
                            <figure class="logo-grey-style"> <img src="<?php echo base_url() ?>assets/images/company-logo/8.png" alt="activeden" class="img-responsive">
                                <figcaption>
                                    <h5>Activeden</h5>
                                </figcaption>
                                <a href="https://activeden.net/" target="_blank"></a>
                            </figure>
                        </li>
                    </ul>
                </div>
